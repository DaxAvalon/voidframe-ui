...
const COMPONENT_OVERRIDES: Record<string, string> = {
  ...
  Lightbox: 'function Example() {\n  const [open, setOpen] = useState(false);\n  return (\n    <>\n      <img src="https://via.placeholder.com/120x80/222/666?text=Photo" style={{ cursor: "pointer", border: "1px solid var(--vf-border-1)" }} onClick={() => setOpen(true)} alt="Click to enlarge" />\n      {open && <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.9)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 10 }} onClick={() => setOpen(false)}>\n        <img src="https://via.placeholder.com/400x300/222/666?text=Enlarged" alt="Full size" />\n      </div>}\n    </>\n  );\n}\nrender(<Example />);',
  ...
  MenuRadioGroup: '<VStack gap={2} style={{ padding: 8, border: "1px solid var(--vf-border-1)" }}>\n  <RadioGroup options={[{ value: "a", label: "Option A" }, { value: "b", label: "Option B" }]} value="a" onChange={() => {}} />\n</VStack>',
  MenuRadioItem: '<RadioGroup options={[{ value: "a", label: "Radio Item" }]} value="a" onChange={() => {}} />',
  ...
  // ── Gestures ───────────────────────────────────────────────────────
  DragDropContext: '<VStack gap={4} style={{ border: "1px solid var(--vf-border-1)", padding: 8 }}>\n  <div style={{ padding: 8, background: "var(--vf-bg-3)", cursor: "grab", border: "1px solid var(--vf-border-0)" }}>&#9776; Draggable Item 1</div>\n  <div style={{ padding: 8, background: "var(--vf-bg-3)", cursor: "grab", border: "1px solid var(--vf-border-0)" }}>&#9776; Draggable Item 2</div>\n  <div style={{ padding: 8, background: "var(--vf-bg-3)", cursor: "grab", border: "1px solid var(--vf-border-0)" }}>&#9776; Draggable Item 3</div>\n</VStack>',
  ...
  Draggable: '<div style={{ padding: 8, background: "var(--vf-bg-3)", cursor: "grab", border: "1px dashed var(--vf-border-2)", display: "inline-flex", gap: 8, alignItems: "center" }}>&#9776; <Text size="sm">Drag me</Text></div>',
  ...
  DashboardGrid: '<div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>\n  <WidgetShell title="Users"><Stat label="Active" value="1,234" /></WidgetShell>\n  <WidgetShell title="Revenue"><Stat label="Total" value="48K" /></WidgetShell>\n  <WidgetShell title="CPU"><Progress value={72} max={100} showValue size="sm" /></WidgetShell>\n  <WidgetShell title="Memory"><Progress value={45} max={100} showValue size="sm" /></WidgetShell>\n</div>',
  ...
  ReorderList: '<VStack gap={4} style={{ border: "1px solid var(--vf-border-1)", padding: 8 }}>\n  <div style={{ padding: 8, background: "var(--vf-bg-3)", cursor: "grab" }}>&#9776; First item</div>\n  <div style={{ padding: 8, background: "var(--vf-bg-3)", cursor: "grab" }}>&#9776; Second item</div>\n  <div style={{ padding: 8, background: "var(--vf-bg-3)", cursor: "grab" }}>&#9776; Third item</div>\n</VStack>',
  Sortable: '<VStack gap={4}>\n  <div style={{ padding: 8, background: "var(--vf-bg-3)", cursor: "grab", border: "1px solid var(--vf-border-0)" }}>&#9776; Sortable A</div>\n  <div style={{ padding: 8, background: "var(--vf-bg-3)", cursor: "grab", border: "1px solid var(--vf-border-0)" }}>&#9776; Sortable B</div>\n</VStack>',
  ...
  Spotlight: 'function Example() {\n  return (\n    <VStack gap={8}>\n      <div style={{ position: "relative" }}>\n        <Button>Target Element</Button>\n        <div style={{ position: "absolute", top: "100%", marginTop: 8, padding: 12, background: "var(--vf-bg-3)", border: "1px solid var(--vf-border-2)", minWidth: 200 }}>\n          <Text size="sm" style={{ fontWeight: 600 }}>Welcome Tour (1/3)</Text>\n          <Text size="xs" style={{ marginTop: 4 }}>Click this button to get started</Text>\n          <HStack gap={4} style={{ marginTop: 8 }}><Button size="sm">Next</Button><Button size="sm" variant="ghost">Skip</Button></HStack>\n        </div>\n      </div>\n    </VStack>\n  );\n}\nrender(<Example />);',
